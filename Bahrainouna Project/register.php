...
class Person {
    ...
    public int $age = 0;
    public DateTime $DOB = new DateTime(), $History;
...
<html lang="en">
    ...
    <body>
        <h1 class="pico">Welcome to Bahrainouna Q&A Registration page</h1><br>
        ...
        <?php
            try {
                $pdo = new PDO("mysql:host=localhost;port=22;dbname=theChallenge", "root", "MOH123ha");
